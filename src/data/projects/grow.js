import { ApplyRepetitionIcon, ProjectOneIcon, ProjectOneServiceOneIcon, ProjectOneServiceThreeIcon, ProjectOneServiceTwoIcon, ProjectOneUserIcon, RecognizeIdentitiesIcon, ReduceFailuresIcon } from "components/Icons";
...
export const grow = {
  ...
  services:{
    ...
    cols:[
      ...
      {
        img: ProjectOneServiceThreeIcon,
  ...
  casestudy:{
    ...
    bodyOut: [
      "Get Up & Grow was applied as a prototypical application to the identified site, client, and project sponsor of Palo Alto Co-operativa. With a total land space of 6.8 hectares, a site analysis revealed 1.10 hectares of potential urban farming space in underused plots and plazas. The types of appropriate agricultural practices were assessed as vertical gardens and raised beds, suitable to the urban landscape. In Mexico City, raised beds lend themselves to passion fruit, lettuce, tomato, and pear cultivation. Vertical gardens are suitable for the cultivation of corn, celery, and chili peppers. With corn being the main agricultural product of Mexico, the proliferation of vertical gardens cultivating native corn species will act as a buffer for the rural food production industry. Since Palo Alto’s land is entirely cooperatively owned — meaning, the residents own the space collectively — it could act as a precedent for community owned urban garden space to mitigate food insecurity and promote sustainable growth in dense urban centers while reducing bureaucratic barriers. However, a key opportunity for this area exists in increasing co-operative value systems and ensuring special governance protections against gentrification, a high risk for the surrounding area. Newcomers can register as gardeners and utilize their agricultural skills and experiences to make a positive contribution to local food production and sustainable development in their new host communities. In the long term, agricultural migrants can achieve self-sufficiency through dignified and secure employment opportunities while Palo Alto Co-operative can benefit from economic growth as well as increasing urban greenery. Other urban communities can replicate the success of Get Up & Grow to promote the integration of agricultural migrants and ensure green development in urban areas."
    ],
    imgs:[
      {
        name:"case-image1.jpg",
        label: "Prototypical service design in action"
      },
      {
        name:"case-image2.jpg",
        label: "Urban agriculture action plan (1)"
      },
      {
        name:"case-image3.jpg",
        label: "Urban agriculture action plan (2)"
      },
      {
